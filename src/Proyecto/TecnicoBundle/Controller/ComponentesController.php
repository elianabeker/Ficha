...
use Proyecto\TecnicoBundle\Form\ComponentesType;
...
class ComponentesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProyectoTecnicoBundle:Componentes')->findAll();
     ...
     * @Method("POST")
     * @Template("ProyectoTecnicoBundle:Componentes:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProyectoTecnicoBundle:Componentes')->find($id);
     ...
     * @Method("PUT")
     * @Template("ProyectoTecnicoBundle:Componentes:edit.html.twig")
     */
