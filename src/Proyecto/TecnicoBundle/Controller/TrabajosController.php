...
use Proyecto\TecnicoBundle\Form\TrabajosType;
...
class TrabajosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProyectoTecnicoBundle:Trabajos')->findAll();
     ...
     *
     * @Route("/", name="trabajos_create")
     * @Method("POST")
     * @Template("ProyectoTecnicoBundle:Trabajos:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProyectoTecnicoBundle:Trabajos')->find($id);
     ...
     *
     * @Route("/{id}", name="trabajos_update")
     * @Method("PUT")
     * @Template("ProyectoTecnicoBundle:Trabajos:edit.html.twig")
     */
